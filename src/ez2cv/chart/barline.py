"""
EZ2CV — chart conversion / barline_reconstruct : beat-phase measure-grid recovery
===============================================================================
detection's measure-line detector is reliable where the playfield is clean but
...
by reconstructing the measure grid from the ONE robust phase reference detection
